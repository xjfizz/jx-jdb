		...
		<view class="widthAutoInner">
			<view class="vip-lb">
				<view class="vip-lb-money" style="line-height: 132upx;width: 100%;">
					头像
					<img :src="memberImg" alt="" class="user-img" @tap="changeHead" />
				</view>
			</view>
			<view class="vip-lb">
				<view class="vip-lb-money">手机号码</view>
				<view class="vip-lb-da"><input  class="vip-lb-input" type="number" value="" placeholder="输入手机号" v-model="retUserPhone"
					 @input="phoneInput" /></view>
			</view>
			<view class="vip-lb">
			...
			<view class="vip-lb">
				...
				<view class="vip-lb-da">
					<input class="vip-lb-input" type="text" value="" placeholder="输入用户名称" v-model="retUserWhatCall" @input="comNameInput" />
				</view>
			</view>
			<view class="vip-lb">
				...
				<view class="vip-lb-da">
					<picker @change="bindPickerChange" :value="index" :range="array" range-key="industryName">
						<view class="uni-input">{{ retUser.supplierIndustry||array[index].industryName }}</view>
