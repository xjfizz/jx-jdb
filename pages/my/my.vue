			...
			<view class="my">
				<view class="header flex align-center">
					<view class="head-img" @tap="goUserDetail">
						<image class="user-img" :src="userInfo.supplierAvatar"></image>
					</view>
					<view class="user-msg">
							<view class="msg-top">
								<text class="msg-top-username">{{userInfo.supplierNickname}}</text>
								
							</view>
					
							<view class="msg-bottom">
								<text class="user-phone">{{userInfo.supplierPhone}}</text>
								<text v-if="userInfo.supplierIdentity == 1" class="user-org">个人</text>
								<text v-if="userInfo.supplierIdentity == 0" class="user-org">企业</text>
								<!-- <text v-if="userInfo.supplierIdentity == 1" class="user-org">待审核</text>
								<text v-if="userInfo.supplierIdentity == 3" class="user-org">已拒绝</text> -->
							</view>
						</view>
