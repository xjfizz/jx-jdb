...
/***/ 11:
/*!******************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/utils/request.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function api(obj) {
  return new Promise(function (resolve, reject) {
    ...
    var header = {
      ...
      'Authorization-xcb': obj.Authorization ? 'Bearer ' + obj.Authorization : '' // obj.Authentication || '' // ('Bearer ' +  obj.Authentication) || ''
    };
    ...
    if (!uni.getStorageSync('isLogin') && url.indexOf('login') == -1 && url.indexOf('list-industry') == -1) {
      console.log('url', url);
...
/***/ 12:
/*!****************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/store/index.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 14:
/*!************************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/utils/public/config.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 15:
/*!**************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/api/index.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 16:
/*!************************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/api/service/service.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var bankCardAttribution = function bankCardAttribution(bankCard) {
  var cardTypeMap = {
    DC: "储蓄卡",
    CC: "信用卡",
    SCC: "准贷记卡",
...
/***/ 17:
/*!*********************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/utils/public/url.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 18:
/*!***********************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/utils/mixins/share.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 374:
/*!*******************************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/components/uni-popup/popup.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 375:
/*!*********************************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/components/uni-popup/message.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/pages.json ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 41:
/*!******************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/utils/factory.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// 格式化银行卡号
var formatBankNo = function formatBankNo(cardNumber) {
  if (cardNumber && cardNumber.length > 8) {
    //return `${cardNumber.substring(0, 4)} ${"*".repeat(cardNumber.length - 8).replace(/(.{4})/g, `$1 `)}${cardNumber.length % 4 ? " " : ""}${cardNumber.slice(-4)}`;
    return "".concat("*".repeat(cardNumber.length - 4).replace(/(.{4})/g, "$1 ")).concat(cardNumber.length % 4 ? " " : "").concat(cardNumber.slice(-4));
  }
  return cardNumber;
};

// 银行卡号安全-格式化
var bankNoSafe = function bankNoSafe(val) {
  // return val.replace(/\s/g,'').replace(/(\d{4})\d+(\d{4})$/, "**** **** **** $2") // **** **** **** 6598
  if (val && val.length > 8) {
    return "".concat(val.substring(0, 4), " ").concat("*".repeat(val.length - 8).replace(/(.{4})/g, "$1 ")).concat(val.length % 4 ? " " : "").concat(val.slice(-4));
    //return `${"*".repeat(cardNumber.length - 4).replace(/(.{4})/g, `$1 `)}${cardNumber.length % 4 ? " " : ""}${cardNumber.slice(-4)}`;
  }
  return val;
};

// 手机号安全-格式化
var phoneNumberSafe = function phoneNumberSafe(val) {
  // return val.replace(/\s/g,'').replace(/(\d{4})\d+(\d{4})$/, "**** **** **** $2") // **** **** **** 6598
  val = val.toString();
  if (val && val.length > 8) {
...
// 身份证安全-格式化
var userIdCardSafe = function userIdCardSafe(val) {
  // return val.replace(/\s/g,'').replace(/(\d{4})\d+(\d{4})$/, "**** **** **** $2") // **** **** **** 6598
  val = val.toString();
  if (val && val.length > 8) {
...
module.exports = {
  ...
  phoneNumberSafe: phoneNumberSafe,
  userIdCardSafe: userIdCardSafe };
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
...
/***/ 425:
/*!*********************************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/components/uni-calendar/util.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _calendar = _interopRequireDefault(__webpack_require__(/*! ./calendar.js */ 426));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var
...
/***/ 426:
/*!*************************************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/components/uni-calendar/calendar.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 483:
/*!**************************************************************************************!*\
  !*** D:/work/OTMS/WEB/jx-web/git/orderReceiver/components/pick-regions/regions.json ***!
  \**************************************************************************************/
